# At what size each instrument begins to see: Haghia Triada, Susa and Uruk measured by distribution

**Alberto Acedo**
Biome Makers Inc. Draft v0.1, 5 September 2026. Not for circulation.
...
## 1. Why compare three archives that cannot be read
...
### 3.2 The partition of the lexicon is the same, and is seen better with more data
...
### 3.3 The compartments, and who makes them
...
### 3.7 Note on the scope of this paper
...
Corpora, scripts and tables accompany the paper. Linear A: lineara.xyz (Hogan 2022) and SigLA; Proto-Elamite and proto-cuneiform: CDLI (cdli.earth), exports of September 2026 included.

## Declaration of assistance

Corpus processing, permutation tests and the first draft of this text were produced with the assistance of a language model (Claude, Anthropic) under the author's direction, who is responsible for all claims.
