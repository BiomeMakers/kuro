# Qué debería declarar una propuesta de lectura para poder ser evaluada: un protocolo de mínimos para escrituras no descifradas

**Alberto Acedo**
Biome Makers Inc. Borrador v0.2, 6 de septiembre de 2026. Destino: una nota de opinión metodológica (Antiquity, Journal of Archaeological Science: Reports, o el foro de una revista del campo). No enviar antes de que los artículos empíricos tengan destino.

## Abstract

Proposals for reading undeciphered scripts appear faster than the field can evaluate them, and the reason is not a shortage of expertise but the absence of a shared minimum of what a proposal must state to be assessable at all. Drawing on the experience of applying a single procedure to five corpora (Linear A, Proto-Elamite, proto-cuneiform, Iberian, Etruscan), and on our own withdrawn results, this note proposes six requirements: a null model for every distributional claim, a positive control on a corpus with known answers, a prediction about unseen text, an explicit count of the tests run and correction for multiple comparisons, verification of every datum in the primary edition rather than in derived transliterations, and publication of the negative results. None of the six is novel in the sciences; none is standard here. The note illustrates each with a case in which its absence produced a false positive, including three of our own.
...
## 2. Los ocho requisitos

### 2.1 Un modelo nulo para cada afirmación distribucional
...
### 2.2 Un control positivo en un corpus con respuesta conocida
...
### 2.3 Una predicción sobre texto no visto
...
### 2.4 Cuántas pruebas se corrieron, y corrección por comparaciones múltiples
...
### 2.5 Verificar el dato en la edición primaria
...
### 2.6 Publicar los negativos con su número
...
### 2.7 Explicar la terminación, o declararla sin explicar
...
### 2.8 Antes de interpretar una ausencia, comprobar que el instrumento podía haberla visto
...
## 3. Lo que el protocolo no exige
...
## 3 bis. El protocolo aplicado a dos propuestas ajenas, y calibrado en una lengua con anclaje
...
### 3 bis bis. El precedente que este protocolo quiere evitar

La necesidad de estos requisitos no es hipotética. Rao y colaboradores (2009) sostuvieron en *Science* que la escritura del valle del Indo codifica una lengua natural, porque su entropía condicional se parece más a la de las lenguas que a la de varios sistemas no lingüísticos; Lee, Jonathan y Ziman (2010) publicaron un argumento del mismo tipo para los símbolos pictos. Sproat (2010) los refutó con un conjunto mayor de corpus no lingüísticos y comparativos, mostrando que ninguna de esas medidas distingue de forma fiable escritura de no escritura, y propuso una medida basada en repetición que clasificaba esos mismos símbolos al revés.

Lo que falló ahí no fue la estadística sino el control: la comparación se hizo contra los sistemas no lingüísticos que los autores eligieron, y no contra el conjunto que habría podido tumbar la afirmación. Es el requisito 2 de esta lista, y el caso muestra su coste: una afirmación publicada en la revista de mayor difusión del mundo, discutida durante años, que un control mejor elegido habría acotado desde el principio.
...
El análisis de los casos y el borrador de este texto se produjeron con la asistencia de un modelo de lenguaje (Claude, Anthropic) bajo la dirección del autor, responsable de todas las afirmaciones.
