# A qué tamaño empieza a ver cada instrumento: Hagia Triada, Susa y Uruk medidos por distribución

**Alberto Acedo**
Biome Makers Inc. Borrador v0.1, 5 de septiembre de 2026. No circular.

## Abstract

Three early administrative archives written in scripts whose languages are not understood, or understood only in part, are measured with a single set of distributional instruments: the Linear A tablets and roundels of Haghia Triada (Crete, c. 1450 BC; 1,117 sign-group tokens, 224 documents with two or more sign-groups), the Proto-Elamite tablets of Susa (Iran, c. 3100-2900 BC; 8,282 entries, 1,594 tablets) and the proto-cuneiform tablets of Uruk IV-III (Mesopotamia, c. 3350-3000 BC; 23,272 entries with numerals, 6,387 tablets). The same quantities are computed in each: the anatomy of the entry, the rate of singletons by length of sign-string, the behaviour that separates counted things from parties (recurrence within a document with different quantities), headings and totals, the exclusivity of vocabulary by document type, co-occurrence and co-exclusion against a fixed-margin null, the numeral systems by object class, and, where hands are attributed, the share of vocabulary explained by the scribe. The three archives share an anatomy (heading, entries of sign-string plus quantity, totals) and a partition of their sign-groups into a closed class of short, repeated commodity terms and an open class of long, singleton names; they differ in what each corpus can show at its size. Co-exclusion between document types, invisible at Haghia Triada, is measurable at Susa (13 pairs) and the inheritance of numeral systems from Uruk to Susa can be tested by structure (sexagesimal inherited, capacity adapted, decimal invented, bisexagesimal not taken). At Haghia Triada, uniquely, the attribution of hands allows the vocabulary to be assigned to scribes rather than to document types. The comparison places Minoan bookkeeping within the typology of early Near Eastern administration without reading a word, and gives, for each instrument, the corpus size at which it begins to see.

**Keywords:** Linear A, Proto-Elamite, proto-cuneiform, administrative archives, null models, co-exclusion, numeral systems, scribal hands.

## Resumen

Tres archivos administrativos tempranos, escritos en escrituras cuyas lenguas no se entienden o se entienden a medias, se miden con un mismo juego de instrumentos distribucionales: las tablillas y rodeles de Hagia Triada en Lineal A (Creta, hacia 1450 a.C.), las tablillas proto-elamitas de Susa (Irán, 3100-2900 a.C.) y las tablillas proto-cuneiformes de Uruk IV-III (Mesopotamia, 3350-3000 a.C.). En cada uno se calculan las mismas cantidades: la anatomía de la entrada, la tasa de hapax por longitud de la cadena de signos, el comportamiento que separa lo contado de las partes (recurrencia dentro de documento con cantidades distintas), cabeceras y totales, la exclusividad del vocabulario por tipo de documento, coocurrencia y coexclusión frente a un nulo de márgenes fijos, los sistemas numerales por clase de objeto y, donde hay manos atribuidas, la parte del vocabulario que explica el escriba. Los tres archivos comparten anatomía y partición del léxico en una clase cerrada de términos de mercancía, cortos y repetidos, y una clase abierta de nombres, largos y únicos; difieren en lo que cada corpus puede mostrar a su tamaño. La comparación sitúa la contabilidad minoica en la tipología de la administración del Oriente antiguo sin leer una palabra, y da, para cada instrumento, el tamaño de corpus a partir del cual empieza a ver.

**Palabras clave:** Lineal A, proto-elamita, proto-cuneiforme, archivos administrativos, modelos nulos, coexclusión, sistemas numerales, manos de escriba.

## 1. Por qué comparar tres archivos que no se leen
...
### 3.2 La partición del léxico es la misma, y se ve mejor con más datos
...
### 3.3 Los compartimentos, y quién los hace
...
### 3.4 Las cadenas largas tienen marco
...
### 3.7 Nota sobre el alcance de este trabajo
...
Corpus, scripts y tablas acompañan al artículo. Lineal A: lineara.xyz (Hogan 2022) y SigLA; proto-elamita y proto-cuneiforme: CDLI (cdli.earth), exportaciones de septiembre de 2026 incluidas.

## Declaración de asistencia

El procesamiento de los corpus, las pruebas de permutación y el primer borrador de este texto se produjeron con la asistencia de un modelo de lenguaje (Claude, Anthropic) bajo la dirección del autor, responsable de todas las afirmaciones.

## Referencias

Acedo, A. 2026g. El recibo minoico es propio: la forma de la contabilidad en seis administraciones del Bronce. Borrador.

Acedo, A. 2026c. Qué puede afirmarse de un corpus de siete mil signos: pruebas con nulos, calibración y confusores en el Lineal A, con el etrusco como control. Borrador.
