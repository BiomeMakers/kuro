...
**Alberto Acedo**
Biome Makers Inc. Borrador v0.1, 11 de septiembre de 2026. No circular.
...
## 4 bis. En qué archivo se fijó cada función

Las 56 unidades se fijaron sobre el corpus entero, pero el corpus es Hagia Triada en un 64%, y los archivos difieren. Khania, la segunda serie (227 documentos, 105 tablillas), no lleva ningún término de suma en ninguna de sus tablillas, frente a 41 de 205 en Hagia Triada (binomial con la tasa de HT: p=7·10⁻¹¹). Su mercancía dominante es el cyperus, el 68% de sus registros llevan fracción (36% en HT) y sus tablillas son la mitad de largas. Es un archivo de distribución menuda frente a un almacén de graneles.

De ahí dos advertencias para el uso de la tabla anterior. La primera: las funciones aritméticas (KU-RO, KI-RO, PO-TO-KU-RO, DA-I) son funciones **del archivo de Hagia Triada**, y su ausencia en Khania no es falta de material. La segunda: los calificadores y encabezados se fijaron con tasas base del corpus entero; medidos con las tasas propias de Khania, ese archivo no aporta ninguno nuevo, y el único que sobrevive allí (PA) viene de Hagia Triada. La excepción es CYP+D, que solo el archivo de Khania permite fijar: lleva la misma cantidad en 12 de sus 16 atestaciones con cifra (base 22%, p=10⁻⁵) y se emite tras entradas de personas, que es la única cantidad del corpus que se comporta como una asignación fija.
